...
/**
 * En klass som representerar en pekare. Med hjälp av denna kan du läsa från och
 * skriva till minnet. Den här filen ska du inte ändra något i. A simple class
 * representing a pointer. It points to a specific address in the memory space
 * (see {@link RawMemory}). Using the pointer, the memory can be read and
 * written.
 * 
